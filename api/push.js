...
async function requireUser(req) {
  ...
  if (!url || !anon) return { ok: false, status: 500, error: 'SUPABASE_URL / SUPABASE_ANON_KEY nisu podešeni.' };
  ...
  } catch (e) { return { ok: false, status: 503, error: 'Provera prijave trenutno nije moguća.' }; }
}
